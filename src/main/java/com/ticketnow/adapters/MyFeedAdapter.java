...
import com.ticketnow.viewholder.MyFeedViewHolder;

import java.util.ArrayList;
import java.util.List;

public class MyFeedAdapter extends RecyclerView.Adapter<MyFeedViewHolder> {

    private Activity activity;
    List<PartyModel> parties;
    int banner;

    public MyFeedAdapter(Activity activity) {

        this.activity = activity;
        banner = R.drawable.banner_emicida;
    ...
    public MyFeedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyFeedViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_rv_myfeed, parent, false));
    }

    @Override
    public void onBindViewHolder(MyFeedViewHolder holder, final int position) {
